        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>
                        Brand List
                        <a href="#" class="btn btn-primary btn-sm float-end" wire:click="openModal"  data-bs-toggle="modal" data-bs-target="#addBrandModal">Add Brand</a>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @forelse ($brands as $brand)
                                <tr>
                                    ...
                                    <td>{{ $brand->status == '1' ? 'Hidden' : 'Visisble' }}</td>
                                    <td>
